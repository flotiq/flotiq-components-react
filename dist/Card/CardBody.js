...
const CardBody = ({
  ...
  const directionClass = context && context.vertical ? 'flex flex-col items-start justify-between basis-full' : '';
  let basisClass = '';
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: ['px-5', 'md:px-10', 'pt-10', 'pb-5', directionClass, basisClass, ...additionalClasses].join(' ')
  }, children);
};
